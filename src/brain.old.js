...
(function() {
  ...
  Brain = (function(_super) {
    ...
    Brain.prototype.srandmember = function(key) {
      ...
      return Q(this.deserialize(set.values()[_.random(0, set.size - 1)]));
    };
    ...
    Brain.prototype.smembers = function(key) {
      var _ref;
      return Q(((_ref = this._data.get(this.key(key))) != null ? _ref.values() : void 0) || null);
    };
    ...
    Brain.prototype.keys = function(searchKey) {
      ...
      return Q(_.map(_.filter(this._data.keys(), function(key) {
    ...
    Brain.prototype.hkeys = function(table) {
      var hash;
      hash = this._data.get(this.key(table));
      if (hash) {
    ...
    Brain.prototype.hvals = function(table) {
      ...
      if (val === void 0) {
        ...
        return Q(_.map(val.values(), this.deserialize.bind(this)));
      }
    };
    ...
    Brain.prototype.userForName = function(name) {
      ...
      user = _.find(this._users.values(), function(user) {
    ...
    Brain.prototype.usersForRawFuzzyName = function(fuzzyName) {
      ...
      users = _.filter(this._users.values(), function(user) {
